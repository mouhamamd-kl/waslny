...
Route::middleware('auth:driver-api')
    ...
    ->group(
        function () {
            ...
            Route::post('/switch-to-online', 'SwitchToOnlineStatus')->name('status.switch-to-online');
            Route::post('/switch-to-offline', 'SwitchToOfflineStatus')->name('status.switch-to-offline');
        }
    );
