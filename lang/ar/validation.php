...
return [
    ...
    */
    ...
    'custom' => [
        'locations' => [
            'trip_location_types' => [
                'pickup' => 'يجب أن يحتوي على نقطة استلام واحدة فقط',
                'dropoff' => 'يجب أن يحتوي على نقطة إنزال واحدة فقط',
            ],
            'trip_location_order' => [
                'pickup_first' => 'يجب أن تكون نقطة الاستلام هي الموقع الأول',
                'dropoff_last' => 'يجب أن تكون نقطة الإنزال هي الموقع الأخير',
            ],
        ],
    ],
