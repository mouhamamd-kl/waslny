...
return [
    ...
    'driver' => [
        ...
        'car' => [
            ...
            'retrieved' => 'تم استرجاع بيانات السيارة بنجاح',
            'error' => [
                'update_failed' => 'فشل تحديث بيانات السيارة',
                'retrieval_failed' => 'فشل استرجاع بيانات السيارة',
            ]
        ]
    ],
    'auth' => [
    ...
    'money_code' => [
        'created' => 'تم إنشاء رمز المال بنجاح',
        'redeemed' => 'تم استرداد رمز المال بنجاح',
        'deleted' => 'تم حذف رمز المال بنجاح',
        'retrieved' => 'تم استرجاع رمز المال بنجاح',
        'list' => 'تم استرجاع قائمة رموز المال بنجاح',
        'error' => [
